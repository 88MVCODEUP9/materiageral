...
const CONFIG = {
  // ─── DADOS DA MATÉRIA ───────────────────────────────
  MATERIA: "Processo Penal",                    // Nome da matéria
  MATERIA_ID: "Processo_penal",              // ID para arquivos
  MATERIA_ICON: "balance",                   // Ícone Material Icons
  MATERIA_COLOR: "#4a85f0",               // Cor principal
  
  // ─── ARQUIVOS ─────────────────────────────────────────────
  DATA_FILE: "data/data_processo_penal.js",     // Arquivo de dados
  DATA_VAR: "DATA_PROCESSO_PENAL",             // Variável global
