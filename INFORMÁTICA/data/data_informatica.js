...
<div class="lex-block">
  ...
  // ╔══════════════════════════════════════════════════════╗
  // ║   NOÇÕES DE SISTEMA OPERACIONAIS (AMBIENTE WINDOWS)  ║
  // ╚══════════════════════════════════════════════════════╝
...
<div class="lex-block">
  ...
  <div class="lex-section-container">
    <div class="lex-section-title">Ferramentas de Sistema</div>
    <div class="lex-expandable-item"><strong>Desfragmentador de Disco:</strong> reorganiza arquivos fragmentados para melhorar desempenho (menos necessário em SSDs).</div>
    <div class="lex-expandable-item"><strong>Limpeza de Disco:</strong> remove arquivos temporários e libera espaço.</div>
    <div class="lex-expandable-item"><strong>Restauração do Sistema:</strong> cria pontos de restauração para reverter alterações.</div>
    <div class="lex-expandable-item"><strong>Windows Update:</strong> atualizações automáticas de segurança e funcionalidades.</div>
    <div class="lex-expandable-item"><strong>Firewall do Windows:</strong> proteção contra acessos não autorizados.</div>
    <div class="lex-expandable-item"><strong>Windows Defender:</strong> antivírus integrado.</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Gerenciamento de Usuários e Permissões</div>
    <div class="lex-expandable-item"><strong>Tipos de conta:</strong> Administrador (controle total) e Padrão (limitado).</div>
    <div class="lex-expandable-item"><strong>Contas de usuário:</strong> cada pessoa pode ter seu próprio perfil com configurações personalizadas.</div>
    <div class="lex-expandable-item"><strong>Controle Parental:</strong> limita tempo de uso e acessos para crianças.</div>
    <div class="lex-expandable-item"><strong>UAC (Controle de Conta de Usuário):</strong> solicita confirmação para alterações importantes.</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Conceitos Importantes</div>
    <div class="lex-expandable-item"><strong>Plug and Play:</strong> dispositivos são reconhecidos e configurados automaticamente.</div>
    <div class="lex-expandable-item"><strong>Drivers:</strong> programas que permitem comunicação entre hardware e sistema operacional.</div>
    <div class="lex-expandable-item"><strong>Virtualização:</strong> Windows permite criar máquinas virtuais para rodar outros sistemas.</div>
    <div class="lex-expandable-item"><strong>Modo de Segurança:</strong> inicia sistema com configurações mínimas para solução de problemas.</div>
    <div class="lex-expandable-item"><strong>Prompt de Comando (CMD):</strong> interface de linha de comando para tarefas avançadas.</div>
    <div class="lex-expandable-item"><strong>PowerShell:</strong> versão moderna do CMD com mais recursos.</div>
  </div>
...
<div class="lex-block">
  ...
  <div class="lex-section-container">
    <div class="lex-section-title">📁 Operações com Arquivos e Pastas</div>
    <div class="lex-expandable-item"><strong>Criar:</strong> clique direito → Novo → Pasta/Arquivo</div>
    <div class="lex-expandable-item"><strong>Copiar:</strong> Ctrl + C ou clique direito → Copiar</div>
    <div class="lex-expandable-item"><strong>Colar:</strong> Ctrl + V ou clique direito → Colar</div>
    <div class="lex-expandable-item"><strong>Recortar:</strong> Ctrl + X ou clique direito → Recortar</div>
    <div class="lex-expandable-item"><strong>Renomear:</strong> F2 ou clique direito → Renomear</div>
    <div class="lex-expandable-item"><strong>Excluir:</strong> Delete (vai para lixeira) ou Shift + Delete (exclusão permanente)</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">📂 Estrutura de Diretórios</div>
    <div class="lex-expandable-item"><strong>Raiz (C:\):</strong> diretório principal do sistema</div>
    <div class="lex-expandable-item"><strong>Windows:</strong> arquivos do sistema operacional</div>
    <div class="lex-expandable-item"><strong>Program Files:</strong> programas instalados (64 bits)</div>
    <div class="lex-expandable-item"><strong>Program Files (x86):</strong> programas 32 bits</div>
    <div class="lex-expandable-item"><strong>Users:</strong> dados dos usuários (Documentos, Downloads, etc.)</div>
    <div class="lex-expandable-item"><strong>ProgramData:</strong> dados compartilhados de programas</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">🔍 Busca e Localização</div>
    <div class="lex-expandable-item"><strong>Barra de Busca:</strong> localizar arquivos e pastas rapidamente</div>
    <div class="lex-expandable-item"><strong>Filtros:</strong> refinar busca por data, tipo, tamanho</div>
    <div class="lex-expandable-item"><strong>Busca Avançada:</strong> operadores como "data:>2023/01/01"</div>
    <div class="lex-expandable-item"><strong>Indexação:</strong> Windows indexa conteúdo para buscas rápidas</div>
    <div class="lex-expandable-item"><strong>Opções de Pesquisa:</strong> incluir conteúdo de arquivos, sistema, ocultos</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">📋 Visualização e Organização</div>
    <div class="lex-expandable-item"><strong>Modos de Exibição:</strong> Ícones grandes/pequenos, Lista, Detalhes, Lado a lado</div>
    <div class="lex-expandable-item"><strong>Ordenação:</strong> por nome, data, tipo, tamanho</div>
    <div class="lex-expandable-item"><strong>Agrupar por:</strong> organizar por data modificada, tipo, etc.</div>
    <div class="lex-expandable-item"><strong>Painel de Detalhes:</strong> informações do arquivo selecionado</div>
    <div class="lex-expandable-item"><strong>Painel de Visualização:</strong> prévia do conteúdo</div>
    <div class="lex-expandable-item"><strong>Navegador:</strong> árvore de diretórios à esquerda</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">⚙️ Configurações e Opções</div>
    <div class="lex-expandable-item"><strong>Exibir:</strong> mostrar/ocultar arquivos ocultos, extensões</div>
    <div class="lex-expandable-item"><strong>Opções de Pasta:</strong> configurações de navegação</div>
    <div class="lex-expandable-item"><strong>Personalizar:</strong> layout do explorador de arquivos</div>
    <div class="lex-expandable-item"><strong>Acesso Rápido:</strong> pastas favoritas e recentes</div>
    <div class="lex-expandable-item"><strong>Bibliotecas:</strong> agrupar pastas de diferentes locais</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">🔐 Permissões e Segurança</div>
    <div class="lex-expandable-item"><strong>Propriedades:</strong> clique direito → Propriedades</div>
    <div class="lex-expandable-item"><strong>Segurança:</strong> permissões de acesso (ler, escrever, executar)</div>
    <div class="lex-expandable-item"><strong>Atributos:</strong> somente leitura, oculto, arquivo</div>
    <div class="lex-expandable-item"><strong>Compartilhamento:</strong> compartilhar pastas na rede</div>
    <div class="lex-expandable-item"><strong>Criptografia:</strong> proteger pastas com senha (EFS)</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">📊 Compactação e Backup</div>
    <div class="lex-expandable-item"><strong>Compactar:</strong> reduzir tamanho de arquivos (ZIP, RAR)</div>
    <div class="lex-expandable-item"><strong>Descompactar:</strong> extrair arquivos compactados</div>
    <div class="lex-expandable-item"><strong>Backup de Arquivos:</strong> cópias de segurança importantes</div>
    <div class="lex-expandable-item"><strong>Histórico de Arquivos:</strong> versões anteriores (Windows 10/11)</div>
    <div class="lex-expandable-item"><strong>Restauração:</strong> recuperar arquivos excluídos ou modificados</div>
  </div>

  <div class="callout callout-gold">
    <span class="callout-icon">💡</span>
    <strong>Bizu:</strong> Win + E = Explorador &nbsp;|&nbsp; F2 = Renomear &nbsp;|&nbsp; Shift + Delete = Exclusão permanente &nbsp;|&nbsp; Bibliotecas = organização virtual
  </div>
</div>
  ...
  <div class="lex-section-container">
    ...
    <div class="lex-cols">
      <div class="lex-section-container">
        ...
        <div class="lex-expandable-item"><strong>Ctrl + U</strong> — Sublinhado</div>
        <div class="lex-expandable-item"><strong>Ctrl + C</strong> — Copiar</div>
        <div class="lex-expandable-item"><strong>Ctrl + V</strong> — Colar</div>
        <div class="lex-expandable-item"><strong>Ctrl + Z</strong> — Desfazer</div>
      ...
      <div class="lex-section-container">
        ...
        <div class="lex-expandable-item"><strong>Ctrl + H</strong> — Substituir</div>
...
<div class="lex-block">
  ...
  <div class="lex-section-container">
    <div class="lex-section-title">🎨 Formatação Avançada</div>
    <div class="lex-expandable-item"><strong>Estilos e Temas:</strong> aplicam formatação consistente em todo o documento (cores, fontes, espaçamento).</div>
    <div class="lex-expandable-item"><strong>Tabulações:</strong> definem pontos de parada para alinhamento de texto (guia Layout → Tabulações).</div>
    <div class="lex-expandable-item"><strong>Espaçamento entre linhas e parágrafos:</strong> controla a distância vertical do texto.</div>
    <div class="lex-expandable-item"><strong>Sombreamento e Bordas:</strong> adicionam destaque visual a trechos de texto ou parágrafos.</div>
    <div class="lex-expandable-item"><strong>Letra Capitular:</strong> primeira letra grande no início do parágrafo (guia Inserir).</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">📊 Recursos de Colaboração</div>
    <div class="lex-expandable-item"><strong>Comentários:</strong> adicionar anotações no documento sem alterar o conteúdo original.</div>
    <div class="lex-expandable-item"><strong>Controle de Alterações:</strong> rastreia todas as modificações feitas no documento.</div>
    <div class="lex-expandable-item"><strong>Comparar Documentos:</strong> mostra diferenças entre duas versões de um arquivo.</div>
    <div class="lex-expandable-item"><strong>Proteger Documento:</strong> restringir edição, comentários ou acesso com senha.</div>
    <div class="lex-expandable-item"><strong>Coautoria:</strong> múltiplos usuários editando o mesmo documento simultaneamente.</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">🔍 Ferramentas de Revisão</div>
    <div class="lex-expandable-item"><strong>Dicionário de Sinônimos:</strong> sugere palavras alternativas (clique com botão direito).</div>
    <div class="lex-expandable-item"><strong>Tradução:</strong> traduz texto para outros idiomas (guia Revisão).</div>
    <div class="lex-expandable-item"><strong>Contagem de Palavras:</strong> estatísticas do documento (palavras, caracteres, parágrafos).</div>
    <div class="lex-expandable-item"><strong>Modo de Foco:</strong> oculta distrações para concentração na escrita.</div>
    <div class="lex-expandable-item"><strong>Leitura em Voz Alta:</strong> Word lê o texto em voz alta.</div>
  </div>
...
<div class="lex-block">
  ...
  <div class="lex-section-container">
    ...
    <div class="lex-expandable-item"><strong>Leitura Dinâmica</strong> — modo otimizado para apresentação sem notas</div>
    <div class="lex-expandable-item"><strong>Página de Anotações</strong> — exibe slide com espaço para anotações do apresentador</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Inserção de Conteúdo</div>
    <div class="lex-expandable-item"><strong>Imagens:</strong> arquivos locais, online, captura de tela, galeria de imagens</div>
    <div class="lex-expandable-item"><strong>Vídeos:</strong> arquivos locais, online (YouTube), gravar tela</div>
    <div class="lex-expandable-item"><strong>Áudio:</strong> arquivos de áudio, gravar narração</div>
    <div class="lex-expandable-item"><strong>Formas:</strong> linhas, retângulos, círculos, setas, caixas de texto</div>
    <div class="lex-expandable-item"><strong>SmartArt:</strong> gráficos organizacionais, fluxogramas, listas hierárquicas</div>
    <div class="lex-expandable-item"><strong>Gráficos:</strong> barras, colunas, pizza, linhas, área</div>
    <div class="lex-expandable-item"><strong>Tabelas:</strong> inserir tabelas com linhas e colunas</div>
    <div class="lex-expandable-item"><strong>Hiperlinks:</strong> links para slides, sites, arquivos</div>
    <div class="lex-expandable-item"><strong>Ações:</strong> configurar cliques em objetos (ir para slide, executar programa)</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Design e Formatação</div>
    <div class="lex-expandable-item"><strong>Temas:</strong> conjuntos predefinidos de cores, fontes e efeitos</div>
    <div class="lex-expandable-item"><strong>Variantes:</strong> diferentes combinações de cores dentro do mesmo tema</div>
    <div class="lex-expandable-item"><strong>Formato do Slide:</strong> padrão (4:3), widescreen (16:9), personalizado</div>
    <div class="lex-expandable-item"><strong>Plano de Fundo:</strong> cores, gradientes, texturas, imagens</div>
    <div class="lex-expandable-item"><strong>Estilos de WordArt:</strong> efeitos artísticos em texto</div>
    <div class="lex-expandable-item"><strong>Contornos e Preenchimentos:</strong> personalizar aparência de formas</div>
    <div class="lex-expandable-item"><strong>Alinhamento e Distribuição:</strong> organizar objetos no slide</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Apresentação e Narração</div>
    <div class="lex-expandable-item"><strong>Apresentar do Início:</strong> F5</div>
    <div class="lex-expandable-item"><strong>Apresentar do Slide Atual:</strong> Shift + F5</div>
    <div class="lex-expandable-item"><strong>Gravar Narração:</strong> gravar áudio sincronizado com slides</div>
    <div class="lex-expandable-item"><strong>Gravar Apresentação:</strong> gravar áudio, vídeo e tempo</div>
    <div class="lex-expandable-item"><strong>Ensinar com Caneta:</strong> desenhar na apresentação</div>
    <div class="lex-expandable-item"><strong>Zoom de Seção:</strong> focar em partes específicas da apresentação</div>
    <div class="lex-expandable-item"><strong>Navegador de Slides:</strong> ver todos os slides durante apresentação</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Animações Detalhadas</div>
    <div class="lex-expandable-item"><strong>Entrada:</strong> como o objeto aparece (aparecer, deslizar, surgir, esmaecer)</div>
    <div class="lex-expandable-item"><strong>Ênfase:</strong> destacar objeto existente (pulsar, girar, mudar cor)</div>
    <div class="lex-expandable-item"><strong>Saída:</strong> como o objeto desaparece (desaparecer, deslizar para fora)</div>
    <div class="lex-expandable-item"><strong>Caminhos de Movimento:</strong> mover objeto pelo slide (linhas, curvas, formas)</div>
    <div class="lex-expandable-item"><strong>Painel de Animação:</strong> controlar ordem e tempo das animações</div>
    <div class="lex-expandable-item"><strong>Gatilhos:</strong> iniciar animação com clique ou automaticamente</div>
    <div class="lex-expandable-item"><strong>Duração e Atraso:</strong> controlar velocidade e início das animações</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Transições Detalhadas</div>
    <div class="lex-expandable-item"><strong>Sutis:</strong> desaparecer, empurrar, cortar, revelar</div>
    <div class="lex-expandable-item"><strong>Empolgantes:</strong> cortina, persiana, gradiente, pirâmide</div>
    <div class="lex-expandable-item"><strong>Conteúdo Dinâmico:</strong> painel, mosaico, virar, girar</div>
    <div class="lex-expandable-item"><strong>Duração:</strong> controlar velocidade da transição</div>
    <div class="lex-expandable-item"><strong>Som:</strong> adicionar efeito sonoro à transição</div>
    <div class="lex-expandable-item"><strong>Avanço:</strong> automático ou com clique</div>
    <div class="lex-expandable-item"><strong>Aplicar a Todos:</strong> mesma transição em todos os slides</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Colaboração e Compartilhamento</div>
    <div class="lex-expandable-item"><strong>Coautoria:</strong> múltiplos usuários editando simultaneamente</div>
    <div class="lex-expandable-item"><strong>Comentários:</strong> adicionar anotações nos slides</div>
    <div class="lex-expandable-item"><strong>Controlar Alterações:</strong> rastrear modificações</div>
    <div class="lex-expandable-item"><strong>Compartilhar na Nuvem:</strong> OneDrive, SharePoint</div>
    <div class="lex-expandable-item"><strong>Apresentar Online:</strong> apresentação via web</div>
    <div class="lex-expandable-item"><strong>Exportar para:</strong> PDF, vídeo, CD, imagens</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Recursos Avançados</div>
    <div class="lex-expandable-item"><strong>Slide Mestre:</strong> padronizar design de todos os slides</div>
    <div class="lex-expandable-item"><strong>Layouts Personalizados:</strong> criar estruturas de slide customizadas</div>
    <div class="lex-expandable-item"><strong>Modelos:</strong> salvar apresentações como modelos reutilizáveis</div>
    <div class="lex-expandable-item"><strong>Macros (VBA):strong> automação de tarefas repetitivas</div>
    <div class="lex-expandable-item"><strong>Seções:</strong> organizar slides em grupos</div>
    <div class="lex-expandable-item"><strong>Sumário Zoom:</strong> navegação interativa entre seções</div>
    <div class="lex-expandable-item"><strong>Painel de Seleção:</strong> selecionar objetos ocultos ou sobrepostos</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Dicas de Apresentação</div>
    <div class="lex-expandable-item"><strong>Use o modo de apresentação:</strong> F5 para começar do início</div>
    <div class="lex-expandable-item"><strong>Navegação durante apresentação:</strong> clique para avançar, setas para voltar</div>
    <div class="lex-expandable-item"><strong>Menu de contexto:</strong> clique direito durante apresentação</div>
    <div class="lex-expandable-item"><strong>Ponteiro a laser:</strong> Ctrl + clique durante apresentação</div>
    <div class="lex-expandable-item"><strong>Anotações do apresentador:</strong> visíveis só para quem apresenta</div>
    <div class="lex-expandable-item"><strong>Tela de pausa:</strong> B (preto) ou W (branco)</div>
    <div class="lex-expandable-item"><strong>Evite excesso de texto:</strong> use pontos e imagens</div>
  </div>
...
<div class="lex-block">
  ...
  <div class="lex-section-container">
    <div class="lex-section-title">🔧 Funções Avançadas</div>
    <div class="lex-expandable-item"><strong>=ÍNDICE()</strong> — retorna valor de uma célula em posição específica da matriz</div>
    <div class="lex-expandable-item"><strong>=CORRESP()</strong> — retorna posição de um valor em um intervalo</div>
    <div class="lex-expandable-item"><strong>=PROCH()</strong> — busca horizontal (PROCV vertical)</div>
    <div class="lex-expandable-item"><strong>=SEERRO()</strong> — trata erros em fórmulas</div>
    <div class="lex-expandable-item"><strong>=ESQUERDA(), =DIREITA(), =EXT.TEXTO()</strong> — manipulação de texto</div>
    <div class="lex-expandable-item"><strong>=CONCATENAR() ou &</strong> — junta textos de células</div>
    <div class="lex-expandable-item"><strong>=DATA(), =HORA(), =MINUTO(), =SEGUNDO()</strong> — manipulação de data/hora</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">📊 Análise de Dados</div>
    <div class="lex-expandable-item"><strong>Cenários:</strong> guia Dados → Análise de Hipóteses — testa diferentes valores</div>
    <div class="lex-expandable-item"><strong>Busca de Objetivo:</strong> encontra valor necessário para atingir resultado específico</div>
    <div class="lex-expandable-item"><strong>Solver:</strong> otimização de valores com restrições</div>
    <div class="lex-expandable-item"><strong>Subtotais:</strong> calcula totais em grupos de dados</div>
    <div class="lex-expandable-item"><strong>Consolidação:</strong> combina dados de múltiplas planilhas</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">🎨 Formatação Profissional</div>
    <div class="lex-expandable-item"><strong>Estilos de Célula:</strong> formatações pré-definidas e consistentes</div>
    <div class="lex-expandable-item"><strong>Formatação Condicional Avançada:</strong> regras complexas com fórmulas</div>
    <div class="lex-expandable-item"><strong>Mini Gráficos:</strong> gráficos pequenos dentro de células</div>
    <div class="lex-expandable-item"><strong>Ícones Conjuntos:</strong> indicadores visuais baseados em valores</div>
    <div class="lex-expandable-item"><strong>Barras de Dados:</strong> barras horizontais dentro das células</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">🔒 Proteção e Segurança</div>
    <div class="lex-expandable-item"><strong>Proteger Planilha:</strong> bloquear células para edição</div>
    <div class="lex-expandable-item"><strong>Proteger Pasta de Trabalho:</strong> proteger estrutura e janelas</div>
    <div class="lex-expandable-item"><strong>Permissões:</strong> definir quem pode editar quais áreas</div>
    <div class="lex-expandable-item"><strong>Marcar como Final:</strong> evitar alterações acidentais</div>
    <div class="lex-expandable-item"><strong>Criptografar com Senha:</strong> proteção级别高级</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">📈 Importação e Exportação</div>
    <div class="lex-expandable-item"><strong>Importar Dados:</strong> de arquivos TXT, CSV, Access, web</div>
    <div class="lex-expandable-item"><strong>Conexões de Dados:</strong> links dinâmicos com bancos de dados</div>
    <div class="lex-expandable-item"><strong>Power Query:</strong> transformação e limpeza de dados avançada</div>
    <div class="lex-expandable-item"><strong>Exportar para:</strong> PDF, CSV, TXT, páginas web</div>
    <div class="lex-expandable-item"><strong>Publicar na Web:</strong> planilhas interativas online</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">⚡ Macros e Automação</div>
    <div class="lex-expandable-item"><strong>Gravar Macro:</strong> registrar ações repetitivas</div>
    <div class="lex-expandable-item"><strong>Editor VBA:</strong> programação personalizada</div>
    <div class="lex-expandable-item"><strong>Botões de Macro:</strong> executar automações com clique</div>
    <div class="lex-expandable-item"><strong>Eventos Automáticos:</strong> macros que rodam em determinadas situações</div>
    <div class="lex-expandable-item"><strong>Segurança de Macros:</strong> habilitar/desabilitar macros</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">🌐 Colaboração e Compartilhamento</div>
    <div class="lex-expandable-item"><strong>Coautoria:</strong> múltiplos usuários editando simultaneamente</div>
    <div class="lex-expandable-item"><strong>Comentários:</strong> anotações em células específicas</div>
    <div class="lex-expandable-item"><strong>Controlar Alterações:</strong> rastrear modificações</div>
    <div class="lex-expandable-item"><strong>Compartilhar na Nuvem:</strong> OneDrive, SharePoint</div>
    <div class="lex-expandable-item"><strong>Versões Anteriores:</strong> histórico de alterações</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">📱 Recursos Especiais</div>
    <div class="lex-expandable-item"><strong>Células de Rápida Acesso:</strong> atalhos para funções frequentes</div>
    <div class="lex-expandable-item"><strong>Painel de Análise Rápida:</strong> sugestões automáticas de formatação</div>
    <div class="lex-expandable-item"><strong>Recomendações de Gráficos:</strong> Excel sugere o melhor tipo de gráfico</div>
    <div class="lex-expandable-item"><strong>Preenchimento Rápido:</strong> completa sequências e padrões automaticamente</div>
    <div class="lex-expandable-item"><strong>Flash Fill:</strong> extrai e formata dados baseados em exemplos</div>
  </div>
</div>`
  },
...
<div style="width: 100%;">
  ...
  <div class="lex-section-container">
    <div class="lex-section-title">🔧 Equipamentos Adicionais</div>
    <div class="lex-expandable-item"><strong>Repetidor:</strong> amplifica o sinal da rede para aumentar alcance</div>
    <div class="lex-expandable-item"><strong>Ponte (Bridge):</strong> conecta duas redes locais diferentes</div>
    <div class="lex-expandable-item"><strong>Gateway:</strong> ponto de entrada/saída entre redes diferentes</div>
    <div class="lex-expandable-item"><strong>Firewall:</strong> dispositivo de segurança que filtra tráfego</div>
    <div class="lex-expandable-item"><strong>Proxy:</strong> servidor intermediário que otimiza e filtra requisições</div>
    <div class="lex-expandable-item"><strong>Load Balancer:</strong> distribui tráfego entre múltiplos servidores</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">📡 Conceitos de Endereçamento</div>
    <div class="lex-expandable-item"><strong>Endereço MAC:</strong> identificação física da placa de rede (fixo)</div>
    <div class="lex-expandable-item"><strong>Endereço IP:</strong> identificação lógica na rede (pode mudar)</div>
    <div class="lex-expandable-item"><strong>ARP:</strong> protocolo que mapeia IP para MAC</div>
    <div class="lex-expandable-item"><strong>DHCP:</strong> atribui IPs automaticamente</div>
    <div class="lex-expandable-item"><strong>DNS:</strong> traduz nomes de domínio para IPs</div>
    <div class="lex-expandable-item"><strong>NAT:</strong> traduz endereços IPs privados para públicos</div>
  </div>
</div>
...
<div class="lex-block">
  ...
  <div class="lex-section-container">
    <div class="lex-section-title">🔧 Recursos Avançados dos Navegadores</div>
    <div class="lex-expandable-item"><strong>Extensões/Plugins:</strong> funcionalidades adicionais (bloqueadores de anúncios, tradutores)</div>
    <div class="lex-expandable-item"><strong>Sincronização:</strong> favoritos, histórico e senhas entre dispositivos</div>
    <div class="lex-expandable-item"><strong>Downloads:</strong> gerenciar arquivos baixados, pausar e retomar</div>
    <div class="lex-expandable-item"><strong>Impressão:</strong> imprimir páginas ou salvar como PDF</div>
    <div class="lex-expandable-item"><strong>Zoom:</strong> aumentar/diminuir tamanho do conteúdo da página</div>
    <div class="lex-expandable-item"><strong>Desenvolvedor:</strong> ferramentas para desenvolvedores web (F12)</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">🛡️ Segurança e Privacidade</div>
    <div class="lex-expandable-item"><strong>Certificados SSL/TLS:</strong> indica conexão segura (https://)</div>
    <div class="lex-expandable-item"><strong>Bloqueador de Pop-ups:</strong> evita janelas indesejadas</div>
    <div class="lex-expandable-item"><strong>Filtro Anti-Phishing:</strong> alerta sobre sites suspeitos</div>
    <div class="lex-expandable-item"><strong>Controle de Privacidade:</strong> gerenciar permissões de sites</div>
    <div class="lex-expandable-item"><strong>Limpeza de Dados:</strong> apagar histórico, cookies, cache</div>
    <div class="lex-expandable-item"><strong>Senhas Salvas:</strong> gerenciador de senhas integrado</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">⚙️ Configurações Importantes</div>
    <div class="lex-expandable-item"><strong>Página Inicial:</strong> site que abre ao iniciar o navegador</div>
    <div class="lex-expandable-item"><strong>Mecanismo de Busca Padrão:</strong> escolher Google, Bing, etc.</div>
    <div class="lex-expandable-item"><strong>Idioma:</strong> configurar idioma de preferência</div>
    <div class="lex-expandable-item"><strong>Aparência:</strong> tema claro/escuro, fontes personalizadas</div>
    <div class="lex-expandable-item"><strong>Downloads:</strong> pasta padrão para arquivos baixados</div>
    <div class="lex-expandable-item"><strong>Notificações:</strong> controlar alertas de sites</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">📱 Navegadores em Dispositivos Móveis</div>
    <div class="lex-expandable-item"><strong>Versões Mobile:</strong> otimizadas para telas pequenas</div>
    <div class="lex-expandable-item"><strong>Modo Desktop:</strong> solicitar versão completa do site</div>
    <div class="lex-expandable-item"><strong>Leitor:</strong> modo de leitura sem distrações</div>
    <div class="lex-expandable-item"><strong>Abas em Grupo:</strong> organizar abas por temas</div>
    <div class="lex-expandable-item"><strong>Leitura Offline:</strong> salvar páginas para acesso sem internet</div>
    <div class="lex-expandable-item"><strong>Compartilhamento:</strong> enviar links para outros aplicativos</div>
  </div>
</div>`
  },
...
<div class="lex-block">
  <div class="notion-header">
    <div class="notion-icon">🔍</div>
    <h1 class="notion-title">Mecanismos de Busca e Pesquisa na Internet</h1>
    <div class="notion-meta">
      <span class="meta-tag tag-b">Google · Bing · DuckDuckGo</span>
      <span class="meta-tag tag-gold">Operadores · Filtros · Avaliação</span>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">O que é um Mecanismo de Busca?</div>
    <div class="lex-expandable-item">Programa que <strong>indexa páginas web</strong> e permite encontrar informações através de palavras-chave.</div>
    <div class="lex-expandable-item">Funciona através de <strong>web crawlers</strong> (robôs) que visitam e analisam páginas constantemente.</div>
    <div class="lex-expandable-item">Os resultados são <strong>classificados por relevância</strong> usando algoritmos complexos.</div>
  </div>

  <div class="lex-cols">
    <div class="lex-section-container">
      <div class="lex-section-title">🔍 Google</div>
      <div class="lex-expandable-item">Mecanismo de busca mais usado no mundo.</div>
      <div class="lex-expandable-item">Possui <strong>90%+ do mercado</strong> de buscas.</div>
      <div class="lex-expandable-item">Oferece busca web, imagens, vídeos, notícias, mapas.</div>
      <div class="lex-expandable-item">Algoritmo: <strong>PageRank</strong> e <strong>RankBrain</strong> (IA).</div>
    </div>
    <div class="lex-section-container">
      <div class="lex-section-title">🔍 Bing</div>
      <div class="lex-expandable-item">Mecanismo da <strong>Microsoft</strong>.</div>
      <div class="lex-expandable-item">Integrado ao Windows e Edge.</div>
      <div class="lex-expandable-item">Possui recursos de busca visual avançada.</div>
      <div class="lex-expandable-item">Usa IA para resumos e conversações.</div>
    </div>
    <div class="lex-section-container">
      <div class="lex-section-title">🔍 DuckDuckGo</div>
      <div class="lex-expandable-item">Foco em <strong>privacidade</strong>.</div>
      <div class="lex-expandable-item"><strong>Não rastreia</strong> usuários ou salva histórico.</div>
      <div class="lex-expandable-item">Resultados de múltiplas fontes.</div>
      <div class="lex-expandable-item">Não cria perfil personalizado.</div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Operadores de Busca Avançados</div>
    <div class="lex-list">
      <div class="lex-expandable-item"><strong>"termos exatos"</strong> — busca pela frase exata entre aspas</div>
      <div class="lex-expandable-item"><strong>-excluir</strong> — remove resultados com este termo</div>
      <div class="lex-expandable-item"><strong>site:domínio.com</strong> — busca apenas em um site específico</div>
      <div class="lex-expandable-item"><strong>filetype:pdf</strong> — busca apenas arquivos de um tipo específico</div>
      <div class="lex-expandable-item"><strong>intitle:título</strong> — busca páginas com o termo no título</div>
      <div class="lex-expandable-item"><strong>inurl:texto</strong> — busca páginas com o termo na URL</div>
      <div class="lex-expandable-item"><strong>OR</strong> — busca um termo OU outro (ex: gato OR cachorro)</div>
      <div class="lex-expandable-item"><strong>..</strong> — busca em um intervalo numérico (ex: 2020..2024)</div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Filtros e Ferramentas de Busca</div>
    <div class="lex-expandable-item"><strong>Filtros de tempo:</strong> última hora, 24 horas, semana, mês, ano, personalizado</div>
    <div class="lex-expandable-item"><strong>Tipo de conteúdo:</strong> todos, notícias, imagens, vídeos, livros</div>
    <div class="lex-expandable-item"><strong>Idioma:</strong> português, inglês, espanhol, etc.</div>
    <div class="lex-expandable-item"><strong>Região:</strong> Brasil, mundo, país específico</div>
    <div class="lex-expandable-item"><strong>Busca segura:</strong> filtro de conteúdo explícito</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Como Avaliar Fontes na Internet</div>
    <div class="lex-expandable-item"><strong>Verifique o domínio:</strong> .gov.br (governo), .edu.br (educação), .org.br (organizações)</div>
    <div class="lex-expandable-item"><strong>Cheque o autor:</strong> quem escreveu? Qual a qualificação?</div>
    <div class="lex-expandable-item"><strong>Data de publicação:</strong> o conteúdo está atualizado?</div>
    <div class="lex-expandable-item"><strong>Fontes citadas:</strong> o artigo referencia outras fontes confiáveis?</div>
    <div class="lex-expandable-item"><strong>Viés:</strong> o conteúdo parece imparcial ou tendencioso?</div>
    <div class="lex-expandable-item"><strong>Desconfie de:</strong> títulos sensacionalistas, falta de fontes, erros gramaticais</div>
  </div>

  <div class="callout callout-gold">
    <span class="callout-icon">💡</span>
    <strong>Bizu:</strong> "termo exato" = frase entre aspas &nbsp;|&nbsp; site: = busca em site específico &nbsp;|&nbsp; filetype: = tipo de arquivo &nbsp;|&nbsp; - = exclui termo
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Busca por Imagens e Voz</div>
    <div class="lex-expandable-item"><strong>Busca por imagem:</strong> upload de foto para encontrar similares ou origem</div>
    <div class="lex-expandable-item"><strong>Busca por voz:</strong> comandos de voz para pesquisar sem digitar</div>
    <div class="lex-expandable-item"><strong>Lente (Google Lens):strong> busca apontando câmera para objetos</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Dicas para Buscas Eficientes</div>
    <div class="lex-expandable-item">Use <strong>termos específicos</strong> em vez de genéricos</div>
    <div class="lex-expandable-item">Combine <strong>múltiplos termos</strong> para refinar resultados</div>
    <div class="lex-expandable-item">Use <strong>aspas</strong> para frases exatas</div>
    <div class="lex-expandable-item">Verifique a <strong>primeira página</strong> de resultados geralmente tem as melhores respostas</div>
    <div class="lex-expandable-item">Use <strong>busca avançada</strong> quando precisar de resultados precisos</div>
  </div>
</div>`
  },
...
<div class="lex-block">
  <div class="notion-header">
    <div class="notion-icon">💬</div>
    <h1 class="notion-title">Grupos de Discussão e Comunidades Online</h1>
    <div class="notion-meta">
      <span class="meta-tag tag-b">Fóruns · Listas · Grupos</span>
      <span class="meta-tag tag-gold">Comunicação Colaborativa</span>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">O que são Grupos de Discussão?</div>
    <div class="lex-expandable-item">Espaços online onde pessoas com <strong>interesses comuns</strong> trocam informações e experiências.</div>
    <div class="lex-expandable-item">Permitem <strong>comunicação assíncrona</strong> (não precisa estar online ao mesmo tempo).</div>
    <div class="lex-expandable-item">São fontes importantes de <strong>ajuda técnica</strong> e <strong>conhecimento compartilhado</strong>.</div>
  </div>

  <div class="lex-cols">
    <div class="lex-section-container">
      <div class="lex-section-title">📋 Fóruns de Discussão</div>
      <div class="lex-expandable-item">Estrutura organizada por <strong>tópicos e categorias</strong>.</div>
      <div class="lex-expandable-item">Mensagens organizadas em <strong>threads</strong> (tópicos).</div>
      <div class="lex-expandable-item">Exemplos: Reddit, Stack Overflow, fóruns de suporte técnico.</div>
      <div class="lex-expandable-item">Permite busca por <strong>soluções anteriores</strong>.</div>
    </div>
    <div class="lex-section-container">
      <div class="lex-section-title">📧 Listas de E-mail</div>
      <div class="lex-expandable-item">Comunicação via <strong>e-mail</strong>.</div>
      <div class="lex-expandable-item">Membros enviam mensagens para um endereço central.</div>
      <div class="lex-expandable-item">Todos os membros recebem as mensagens.</div>
      <div class="lex-expandable-item">Exemplos: grupos Yahoo, Google Groups.</div>
    </div>
    <div class="lex-section-container">
      <div class="lex-section-title">💬 Grupos de Chat</div>
      <div class="lex-expandable-item">Comunicação em <strong>tempo real</strong>.</div>
      <div class="lex-expandable-item">WhatsApp, Telegram, Discord.</div>
      <div class="lex-expandable-item">Canais organizados por temas.</div>
      <div class="lex-expandable-item">Ideal para <strong>respostas rápidas</strong>.</div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Principais Plataformas</div>
    <div class="lex-list">
      <div class="lex-expandable-item"><strong>Reddit:</strong> rede social com comunidades (subreddits) sobre qualquer tema</div>
      <div class="lex-expandable-item"><strong>Stack Overflow:</strong> programadores ajudam outros programadores</div>
      <div class="lex-expandable-item"><strong>Quora:</strong> perguntas e respostas sobre diversos assuntos</div>
      <div class="lex-expandable-item"><strong>LinkedIn Groups:</strong> grupos profissionais e de negócios</div>
      <div class="lex-expandable-item"><strong>Facebook Groups:</strong> grupos de interesse geral</div>
      <div class="lex-expandable-item"><strong>Discord:</strong> servidores de gaming e comunidades diversas</div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Estrutura de um Fórum Típico</div>
    <div class="lex-expandable-item"><strong>Categorias:</strong> divisões principais do fórum</div>
    <div class="lex-expandable-item"><strong>Fóruns/Subfóruns:</strong> subdivisões por temas específicos</div>
    <div class="lex-expandable-item"><strong>Tópicos/Threads:</strong> discussões individuais</div>
    <div class="lex-expandable-item"><strong>Posts/Mensagens:</strong> respostas dentro de um tópico</div>
    <div class="lex-expandable-item"><strong>Moderadores:</strong> usuários que gerenciam o conteúdo</div>
    <div class="lex-expandable-item"><strong>Regras:</strong> normas de conduta da comunidade</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Boas Práticas em Grupos de Discussão</div>
    <div class="lex-expandable-item"><strong>Leia as regras:</strong> cada comunidade tem suas próprias normas</div>
    <div class="lex-expandable-item"><strong>Busque antes de perguntar:</strong> sua dúvida pode já ter sido respondida</div>
    <div class="lex-expandable-item"><strong>Seja claro:</strong> descreva bem seu problema ou pergunta</div>
    <div class="lex-expandable-item"><strong>Seja educado:</strong> respeite outros membros</div>
    <div class="lex-expandable-item"><strong>Agradeça:</strong> reconheça quem te ajudou</div>
    <div class="lex-expandable-item"><strong>Contribua:</strong> ajude outros quando puder</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Termos Comuns</div>
    <div class="lex-expandable-item"><strong>Thread:</strong> sequência de mensagens sobre um mesmo assunto</div>
    <div class="lex-expandable-item"><strong>Post:</strong> mensagem individual em um fórum ou grupo</div>
    <div class="lex-expandable-item"><strong>OP (Original Poster):strong> autor da mensagem inicial</div>
    <div class="lex-expandable-item"><strong>Bump:</strong> postar para trazer o tópico para o topo</div>
    <div class="lex-expandable-item"><strong>Sticky/Pin:</strong> tópico fixado no topo</div>
    <div class="lex-expandable-item"><strong>Locked:</strong> tópico fechado para novas respostas</div>
  </div>

  <div class="callout callout-gold">
    <span class="callout-icon">💡</span>
    <strong>Bizu:</strong> Fórum = organizado por tópicos &nbsp;|&nbsp; Lista de e-mail = comunicação por e-mail &nbsp;|&nbsp; Grupo de chat = tempo real
  </div>
</div>`
  },
...
<div class="lex-block">
  <div class="notion-header">
    <div class="notion-icon">📱</div>
    <h1 class="notion-title">Redes Sociais</h1>
    <div class="notion-meta">
      <span class="meta-tag tag-b">Facebook · Instagram · LinkedIn</span>
      <span class="meta-tag tag-gold">Perfil · Post · Privacidade</span>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">O que são Redes Sociais?</div>
    <div class="lex-expandable-item">Plataformas online que permitem <strong>conectar pessoas</strong> e compartilhar conteúdo.</div>
    <div class="lex-expandable-item">Baseadas em <strong>perfis de usuários</strong> e <strong>conexões sociais</strong> (amigos, seguidores).</div>
    <div class="lex-expandable-item">Permitem compartilhamento de texto, imagens, vídeos e links.</div>
  </div>

  <div class="lex-cols">
    <div class="lex-section-container">
      <div class="lex-section-title">📘 Facebook</div>
      <div class="lex-expandable-item">Maior rede social do mundo (2+ bilhões de usuários).</div>
      <div class="lex-expandable-item"><strong>Perfil pessoal:</strong> informações básicas, fotos, interesses.</div>
      <div class="lex-expandable-item"><strong>Timeline:</strong> linha do tempo com posts e atualizações.</div>
      <div class="lex-expandable-item"><strong>Grupos:</strong> comunidades de interesse comum.</div>
      <div class="lex-expandable-item"><strong>Páginas:</strong> perfis de empresas, marcas e celebridades.</div>
      <div class="lex-expandable-item"><strong>Messenger:</strong> chat integrado para conversas.</div>
    </div>
    <div class="lex-section-container">
      <div class="lex-section-title">📷 Instagram</div>
      <div class="lex-expandable-item">Foco em <strong>conteúdo visual</strong> (fotos e vídeos).</div>
      <div class="lex-expandable-item"><strong>Feed:</strong> galeria de posts em formato quadrado.</div>
      <div class="lex-expandable-item"><strong>Stories:</strong> conteúdo temporário (24 horas).</div>
      <div class="lex-expandable-item"><strong>Reels:</strong> vídeos curtos com música e efeitos.</div>
      <div class="lex-expandable-item"><strong>IGTV:</strong> vídeos longos.</div>
      <div class="lex-expandable-item"><strong>Direct:</strong> mensagens privadas.</div>
    </div>
    <div class="lex-section-container">
      <div class="lex-section-title">💼 LinkedIn</div>
      <div class="lex-expandable-item">Rede social <strong>profissional</strong>.</div>
      <div class="lex-expandable-item"><strong>Perfil profissional:</strong> currículo, experiências, habilidades.</div>
      <div class="lex-expandable-item"><strong>Conexões:</strong> contatos profissionais.</div>
      <div class="lex-expandable-item"><strong>Feed profissional:</strong> artigos, vagas de emprego.</div>
      <div class="lex-expandable-item"><strong>Empresas:</strong> páginas corporativas.</div>
      <div class="lex-expandable-item"><strong>Endossos:</strong> validações de habilidades.</div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Outras Redes Sociais Importantes</div>
    <div class="lex-list">
      <div class="lex-expandable-item"><strong>Twitter/X:</strong> microblogging com mensagens curtas (280 caracteres)</div>
      <div class="lex-expandable-item"><strong>WhatsApp:</strong> mensagens instantâneas com status e comunidades</div>
      <div class="lex-expandable-item"><strong>Telegram:</strong> mensagens com canais e bots</div>
      <div class="lex-expandable-item"><strong>TikTok:</strong> vídeos curtos com música e tendências</div>
      <div class="lex-expandable-item"><strong>YouTube:</strong> plataforma de vídeos com comunidade</div>
      <div class="lex-expandable-item"><strong>Pinterest:</strong> compartilhamento de imagens e ideias</div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Conceitos Fundamentais</div>
    <div class="lex-expandable-item"><strong>Perfil/Account:</strong> página pessoal com informações do usuário</div>
    <div class="lex-expandable-item"><strong>Post/Publicação:</strong> conteúdo compartilhado na rede</div>
    <div class="lex-expandable-item"><strong>Timeline/Feed:</strong> linha do tempo com posts de conexões</div>
    <div class="lex-expandable-item"><strong>Like/Curtir:</strong> indica aprovação de um post</div>
    <div class="lex-expandable-item"><strong>Comment/Comentário:</strong> resposta a um post</div>
    <div class="lex-expandable-item"><strong>Share/Compartilhar:</strong> repassar conteúdo para outros</div>
    <div class="lex-expandable-item"><strong>Follow/Seguir:</strong> receber atualizações de um usuário</div>
    <div class="lex-expandable-item"><strong>Friend/Amigo:</strong> conexão mútua no Facebook</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Privacidade e Segurança</div>
    <div class="lex-expandable-item"><strong>Configurações de privacidade:</strong> controle sobre quem vê seu conteúdo</div>
    <div class="lex-expandable-item"><strong>Perfil público vs privado:</strong> visibilidade limitada ou aberta</div>
    <div class="lex-expandable-item"><strong>Autenticação em dois fatores:</strong> proteção adicional da conta</div>
    <div class="lex-expandable-item"><strong>Bloqueio de usuários:</strong> impedir contato indesejado</div>
    <div class="lex-expandable-item"><strong>Cuidado com informações pessoais:</strong> não compartilhar dados sensíveis</div>
    <div class="lex-expandable-item"><strong>Phishing em redes sociais:</strong> cuidado com links suspeitos</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Uso Pessoal vs Profissional</div>
    <div class="lex-expandable-item"><strong>Uso pessoal:</strong> conexão com amigos e família, compartilhamento casual</div>
    <div class="lex-expandable-item"><strong>Uso profissional:</strong> networking, marca pessoal, oportunidades de negócio</div>
    <div class="lex-expandable-item"><strong>Empresas:</strong> marketing digital, atendimento ao cliente, recrutamento</div>
    <div class="lex-expandable-item"><strong>Separar contas:</strong> muitos profissionais mantêm perfis diferentes</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Riscos e Cuidados</div>
    <div class="lex-expandable-item"><strong>Dependência digital:</strong> uso excessivo pode afetar produtividade</div>
    <div class="lex-expandable-item"><strong>Comparação social:</strong> impacto na saúde mental</div>
    <div class="lex-expandable-item"><strong>Desinformação:</strong> fake news e boatos</div>
    <div class="lex-expandable-item"><strong>Cyberbullying:</strong> assédio online</div>
    <div class="lex-expandable-item"><strong>Segurança de dados:</strong> proteção de informações pessoais</div>
  </div>

  <div class="callout callout-gold">
    <span class="callout-icon">💡</span>
    <strong>Bizu:</strong> Facebook = geral &nbsp;|&nbsp; Instagram = visual &nbsp;|&nbsp; LinkedIn = profissional &nbsp;|&nbsp; Twitter = mensagens curtas
  </div>
</div>`
  },
...
<div class="lex-block">
  <div class="notion-header">
    <div class="notion-icon">☁️</div>
    <h1 class="notion-title">Computação na Nuvem (Cloud Computing)</h1>
    <div class="notion-meta">
      <span class="meta-tag tag-b">IaaS · PaaS · SaaS</span>
      <span class="meta-tag tag-gold">AWS · Azure · Google Cloud</span>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">O que é Computação na Nuvem?</div>
    <div class="lex-expandable-item">Entrega de <strong>serviços de computação</strong> (servidores, armazenamento, bancos de dados) pela internet.</div>
    <div class="lex-expandable-item">Em vez de comprar e manter servidores físicos, você <strong>aluga recursos</strong> de provedores.</div>
    <div class="lex-expandable-item">Acesso aos recursos <strong>de qualquer lugar</strong> com conexão à internet.</div>
    <div class="lex-expandable-item">Modelo <strong>pay-as-you-go</strong>: paga só pelo que usa.</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Características Principais</div>
    <div class="lex-list">
      <div class="lex-expandable-item"><strong>Autoatendimento sob demanda:</strong> usuário provisiona recursos sem precisar do provedor</div>
      <div class="lex-expandable-item"><strong>Amplo acesso à rede:</strong> disponível através da internet</div>
      <div class="lex-expandable-item"><strong>Pool de recursos:</strong> recursos compartilhados entre múltiplos clientes</div>
      <div class="lex-expandable-item"><strong>Rapidez elástica:</strong> escala rapidamente para cima ou para baixo</div>
      <div class="lex-expandable-item"><strong>Serviço medido:</strong> uso monitorado e cobrado automaticamente</div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Modelos de Serviço</div>
    <div class="lex-cols">
      <div class="lex-section-container">
        <div class="lex-section-title">🏗️ IaaS (Infrastructure as a Service)</div>
        <div class="lex-expandable-item"><strong>Infraestrutura como Serviço</strong>.</div>
        <div class="lex-expandable-item">Aluga <strong>servidores virtuais, armazenamento, redes</strong>.</div>
        <div class="lex-expandable-item">Você controla o <strong>sistema operacional e aplicativos</strong>.</div>
        <div class="lex-expandable-item">Máxima flexibilidade e controle.</div>
        <div class="lex-expandable-item">Exemplos: Amazon EC2, Google Compute Engine.</div>
      </div>
      <div class="lex-section-container">
        <div class="lex-section-title">⚙️ PaaS (Platform as a Service)</div>
        <div class="lex-expandable-item"><strong>Plataforma como Serviço</strong>.</div>
        <div class="lex-expandable-item">Fornece <strong>ambiente para desenvolver e executar</strong> aplicativos.</div>
        <div class="lex-expandable-item">Provedor gerencia infraestrutura, você foca no código.</div>
        <div class="lex-expandable-item">Banco de dados, servidores web, ferramentas de desenvolvimento.</div>
        <div class="lex-expandable-item">Exemplos: Heroku, Google App Engine, AWS Elastic Beanstalk.</div>
      </div>
      <div class="lex-section-container">
        <div class="lex-section-title">📱 SaaS (Software as a Service)</div>
        <div class="lex-expandable-item"><strong>Software como Serviço</strong>.</div>
        <div class="lex-expandable-item">Aplicativos <strong>prontos para uso</strong> via navegador.</div>
        <div class="lex-expandable-item">Sem instalação ou manutenção.</div>
        <div class="lex-expandable-item">Assinatura mensal/anual.</div>
        <div class="lex-expandable-item">Exemplos: Gmail, Office 365, Salesforce, Netflix.</div>
      </div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Modelos de Implantação</div>
    <div class="lex-list">
      <div class="lex-expandable-item"><strong>Nuvem Pública:</strong> recursos compartilhados com o público geral (AWS, Azure, Google Cloud)</div>
      <div class="lex-expandable-item"><strong>Nuvem Privada:</strong> infraestrutura exclusiva para uma organização</div>
      <div class="lex-expandable-item"><strong>Nuvem Híbrida:</strong> combinação de nuvem pública e privada</div>
      <div class="lex-expandable-item"><strong>Nuvem Comunitária:</strong> compartilhada por várias organizações com interesses comuns</div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Principais Provedores</div>
    <div class="lex-cols">
      <div class="lex-section-container">
        <div class="lex-section-title">🟠 Amazon Web Services (AWS)</div>
        <div class="lex-expandable-item">Maior provedor mundial (~32% do mercado).</div>
        <div class="lex-expandable-item">Lançado em 2006.</div>
        <div class="lex-expandable-item">Mais de 200 serviços diferentes.</div>
        <div class="lex-expandable-item">Serviços famosos: EC2, S3, RDS, Lambda.</div>
      </div>
      <div class="lex-section-container">
        <div class="lex-section-title">🔵 Microsoft Azure</div>
        <div class="lex-expandable-item">Segundo maior provedor (~23% do mercado).</div>
        <div class="lex-expandable-item">Forte integração com produtos Microsoft.</div>
        <div class="lex-expandable-item">Popular em empresas Windows.</div>
        <div class="lex-expandable-item">Serviços: Virtual Machines, Blob Storage, SQL Database.</div>
      </div>
      <div class="lex-section-container">
        <div class="lex-section-title">🟡 Google Cloud Platform (GCP)</div>
        <div class="lex-expandable-item">Terceiro maior provedor (~11% do mercado).</div>
        <div class="lex-expandable-item">Forte em IA, Machine Learning e análise de dados.</div>
        <div class="lex-expandable-item">Infraestrutura do Google Search e YouTube.</div>
        <div class="lex-expandable-item">Serviços: Compute Engine, Cloud Storage, BigQuery.</div>
      </div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Vantagens da Computação na Nuvem</div>
    <div class="lex-expandable-item"><strong>Redução de custos:</strong> sem investimento inicial em hardware</div>
    <div class="lex-expandable-item"><strong>Escalabilidade:</strong> aumenta ou diminui recursos conforme necessidade</div>
    <div class="lex-expandable-item"><strong>Acessibilidade:</strong> acesso de qualquer lugar, a qualquer hora</div>
    <div class="lex-expandable-item"><strong>Atualizações automáticas:</strong> provedor mantém infraestrutura atualizada</div>
    <div class="lex-expandable-item"><strong>Backup e recuperação:</strong> proteção de dados integrada</div>
    <div class="lex-expandable-item"><strong>Colaboração:</strong> múltiplos usuários acessando os mesmos recursos</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Desvantagens e Riscos</div>
    <div class="lex-expandable-item"><strong>Dependência de internet:</strong> sem conexão, sem acesso aos serviços</div>
    <div class="lex-expandable-item"><strong>Segurança:</strong> preocupações com privacidade e proteção de dados</div>
    <div class="lex-expandable-item"><strong>Custos inesperados:</strong> uso excessivo pode gerar contas altas</div>
    <div class="lex-expandable-item"><strong>Vendor lock-in:</strong> dificuldade de mudar de provedor</div>
    <div class="lex-expandable-item"><strong>Conformidade:</strong> regulamentações sobre localização de dados</div>
  </div>

  <div class="callout callout-gold">
    <span class="callout-icon">💡</span>
    <strong>Bizu:</strong> IaaS = infraestrutura (você controla tudo) &nbsp;|&nbsp; PaaS = plataforma (você controla o código) &nbsp;|&nbsp; SaaS = software pronto (só usa)
  </div>
</div>`
  },

  // ╔══════════════════════════════════════════════════════╗
  // ║           ARMazenamento NA NUVEM (STORAGE)            ║
  // ╚══════════════════════════════════════════════════════╝
...
<div class="lex-block">
  <div class="notion-header">
    <div class="notion-icon">💾</div>
    <h1 class="notion-title">Armazenamento de Dados na Nuvem (Cloud Storage)</h1>
    <div class="notion-meta">
      <span class="meta-tag tag-b">Google Drive · OneDrive · Dropbox</span>
      <span class="meta-tag tag-gold">Sincronização · Backup · Segurança</span>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">O que é Armazenamento na Nuvem?</div>
    <div class="lex-expandable-item">Serviço que permite <strong>salvar arquivos online</strong> e acessá-los de qualquer dispositivo.</div>
    <div class="lex-expandable-item">Arquivos ficam armazenados em <strong>servidores do provedor</strong>, não no seu computador.</div>
    <div class="lex-expandable-item">Acesso através de <strong>navegador web</strong> ou <strong>aplicativos dedicados</strong>.</div>
    <div class="lex-expandable-item">Ideal para <strong>backup, compartilhamento e colaboração</strong>.</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Principais Serviços</div>
    <div class="lex-cols">
      <div class="lex-section-container">
        <div class="lex-section-title">🟦 Google Drive</div>
        <div class="lex-expandable-item">Integrado ao <strong>ecossistema Google</strong> (Gmail, Google Docs).</div>
        <div class="lex-expandable-item"><strong>15 GB gratuitos</strong> compartilhados com Gmail e Google Fotos.</div>
        <div class="lex-expandable-item">Suíte Office online: Docs, Sheets, Slides.</div>
        <div class="lex-expandable-item">Excelente para <strong>colaboração em tempo real</strong>.</div>
        <div class="lex-expandable-item">Disponível para web, desktop e mobile.</div>
      </div>
      <div class="lex-section-container">
        <div class="lex-section-title">🟦 Microsoft OneDrive</div>
        <div class="lex-expandable-item">Integrado ao <strong>Windows 10/11</strong> e Microsoft 365.</div>
        <div class="lex-expandable-item"><strong>5 GB gratuitos</strong>.</div>
        <div class="lex-expandable-item">Sincronização perfeita com Office (Word, Excel, PowerPoint).</div>
        <div class="lex-expandable-item">Versão pessoal e empresarial.</div>
        <div class="lex-expandable-item">Recursos de compartilhamento e segurança avançados.</div>
      </div>
      <div class="lex-section-container">
        <div class="lex-section-title">🟦 Dropbox</div>
        <div class="lex-expandable-item">Um dos <strong>primeiros</strong> serviços de armazenamento na nuvem.</div>
        <div class="lex-expandable-item"><strong>2 GB gratuitos</strong> (expansível através de indicações).</div>
        <div class="lex-expandable-item">Foco em <strong>sincronização de arquivos</strong>.</div>
        <div class="lex-expandable-item">Rápido e confiável para backup automático.</div>
        <div class="lex-expandable-item">Recursos empresariais robustos.</div>
      </div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Outros Serviços Importantes</div>
    <div class="lex-list">
      <div class="lex-expandable-item"><strong>iCloud Drive:</strong> serviço da Apple, integrado a dispositivos iOS/macOS</div>
      <div class="lex-expandable-item"><strong>Amazon Drive:</strong> serviço da Amazon, integrado à Prime</div>
      <div class="lex-expandable-item"><strong>pCloud:</strong> serviço com criptografia e lifetime plans</div>
      <div class="lex-expandable-item"><strong>MEGA:</strong> 20 GB gratuitos com foco em privacidade</div>
      <div class="lex-expandable-item"><strong>Box:</strong> focado em empresas e segurança corporativa</div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Sincronização vs Backup</div>
    <div class="lex-expandable-item"><strong>Sincronização:</strong> mantém arquivos <strong>idênticos</strong> entre dispositivos e nuvem</div>
    <div class="lex-expandable-item"><strong>Backup:</strong> cópia de segurança <strong>imutável</strong> para recuperação</div>
    <div class="lex-expandable-item">Se você apaga um arquivo sincronizado → apaga em todos os lugares</div>
    <div class="lex-expandable-item">Backup mantém <strong>versões anteriores</strong> e proteção contra exclusão</div>
    <div class="lex-expandable-item">Ideal: usar <strong>ambos</strong> para proteção completa</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Funcionalidades Principais</div>
    <div class="lex-expandable-item"><strong>Upload de arquivos:</strong> arrastar e soltar ou selecionar arquivos</div>
    <div class="lex-expandable-item"><strong>Compartilhamento:</strong> criar links para compartilhar arquivos/pastas</div>
    <div class="lex-expandable-item"><strong>Controle de acesso:</strong> definir permissões (visualizar, editar, comentar)</div>
    <div class="lex-expandable-item"><strong>Versionamento:</strong> manter histórico de alterações dos arquivos</div>
    <div class="lex-expandable-item"><strong>Acesso offline:</strong> baixar arquivos para uso sem internet</div>
    <div class="lex-expandable-item"><strong>Busca:</strong> encontrar arquivos por nome, conteúdo ou tipo</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Segurança no Armazenamento Cloud</div>
    <div class="lex-expandable-item"><strong>Criptografia:</strong> dados criptografados durante transmissão e armazenamento</div>
    <div class="lex-expandable-item"><strong>Autenticação:</strong> login com senha, 2FA, biometria</div>
    <div class="lex-expandable-item"><strong>Permissões:</strong> controle granular de quem pode acessar o quê</div>
    <div class="lex-expandable-item"><strong>Audit logs:</strong> registro de quem acessou ou modificou arquivos</div>
    <div class="lex-expandable-item"><strong>Conformidade:</strong> GDPR, LGPD e outras regulamentações</div>
    <div class="lex-expandable-item"><strong>Cuidados do usuário:</strong> senhas fortes, não compartilhar acesso, revisar permissões</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Planos e Preços</div>
    <div class="lex-expandable-item"><strong>Planos gratuitos:</strong> espaço limitado (2-15 GB) para uso pessoal</div>
    <div class="lex-expandable-item"><strong>Planos pessoais:</strong> 100 GB a 2 TB, mensal ou anual</div>
    <div class="lex-expandable-item"><strong>Planos familiares:</strong> compartilhamento com até 6 pessoas</div>
    <div class="lex-expandable-item"><strong>Planos empresariais:</strong> espaço ilimitado, recursos avançados, suporte</div>
    <div class="lex-expandable-item"><strong>Pay-as-you-go:</strong> paga pelo espaço realmente utilizado</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Melhores Práticas</div>
    <div class="lex-expandable-item"><strong>Use autenticação em dois fatores</strong> para proteger sua conta</div>
    <div class="lex-expandable-item"><strong>Não armazene dados muito sensíveis</strong> em serviços gratuitos</div>
    <div class="lex-expandable-item"><strong>Faça backup local</strong> dos arquivos mais importantes</div>
    <div class="lex-expandable-item"><strong>Revise permissões</strong> de compartilhamento regularmente</div>
    <div class="lex-expandable-item"><strong>Monitore o uso</strong> para evitar surpresas na fatura</div>
    <div class="lex-expandable-item"><strong>Use criptografia adicional</strong> para dados confidenciais</div>
  </div>

  <div class="callout callout-gold">
    <span class="callout-icon">💡</span>
    <strong>Bizu:</strong> Google Drive = integração Google &nbsp;|&nbsp; OneDrive = integração Windows/Office &nbsp;|&nbsp; Dropbox = sincronização rápida &nbsp;|&nbsp; Sincronização ≠ Backup
  </div>
</div>`
  },
...
<div class="lex-block">
  ...
  <div class="lex-section-container">
    ...
    <div class="lex-expandable-item"><strong>SMTP (Simple Mail Transfer Protocol)</strong> — protocolo para <strong>enviar</strong> e-mails (porta 25).</div>
    <div class="lex-expandable-item"><strong>POP3 (Post Office Protocol 3)</strong> — protocolo para <strong>receber</strong> e-mails (porta 110). Baixa mensagens para o computador e apaga do servidor.</div>
    <div class="lex-expandable-item"><strong>IMAP (Internet Message Access Protocol)</strong> — protocolo para <strong>receber</strong> e-mails (porta 143). Mantém mensagens no servidor, permite acesso de múltiplos dispositivos.</div>
    <div class="lex-expandable-item"><strong>Seguros:</strong> SMTPS (465/587), POP3S (995), IMAPS (993) com criptografia SSL/TLS.</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Microsoft Outlook</div>
    <div class="lex-expandable-item"><strong>Cliente de e-mail</strong> mais usado em ambiente corporativo.</div>
    <div class="lex-expandable-item">Integrado com <strong>Microsoft 365/Office</strong> (Word, Excel, Calendar).</div>
    <div class="lex-expandable-item"><strong>Calendário:</strong> agendamento de compromissos e reuniões.</div>
    <div class="lex-expandable-item"><strong>Contatos:</strong> gerenciamento de lista de contatos.</div>
    <div class="lex-expandable-item"><strong>Tarefas:</strong> lista de afazeres integrada.</div>
    <div class="lex-expandable-item"><strong>Regras:</strong> filtros automáticos para organizar e-mails.</div>
    <div class="lex-expandable-item"><strong>Pasta de Arquivamento:</strong> organizar mensagens antigas.</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Segurança em E-mail</div>
    <div class="lex-expandable-item"><strong>Spam:</strong> e-mails não solicitados, geralmente publicidade.</div>
    <div class="lex-expandable-item"><strong>Phishing:</strong> tentativa de fraude para roubar dados pessoais.</div>
    <div class="lex-expandable-item"><strong>Malware em Anexos:</strong> vírus e outros softwares maliciosos.</div>
    <div class="lex-expandable-item"><strong>Criptografia:</strong> proteger conteúdo do e-mail (PGP, S/MIME).</div>
    <div class="lex-expandable-item"><strong>Assinatura Digital:</strong> verificar autenticidade do remetente.</div>
    <div class="lex-expandable-item"><strong>Filtros Anti-Spam:</strong> bloqueiam mensagens suspeitas.</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Funcionalidades Avançadas</div>
    <div class="lex-expandable-item"><strong>Respostas Automáticas:</strong> ausência do escritório.</div>
    <div class="lex-expandable-item"><strong>Encaminhamento:</strong> redirecionar e-mails para outra conta.</div>
    <div class="lex-expandable-item"><strong>Grupos de Distribuição:</strong> enviar para múltiplos contatos simultaneamente.</div>
    <div class="lex-expandable-item"><strong>Calendário Compartilhado:</strong> agendar reuniões com outros.</div>
    <div class="lex-expandable-item"><strong>Solicitações de Leitura:</strong> confirmar quando e-mail foi lido.</div>
    <div class="lex-expandable-item"><strong>Votação:</strong> criar enquetes por e-mail.</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Boas Práticas</div>
    <div class="lex-expandable-item"><strong>Assunto claro:</strong> descreva bem o conteúdo do e-mail.</div>
    <div class="lex-expandable-item"><strong>Use Cc e Bcc corretamente:</strong> Cc para visibilidade, Bcc para privacidade.</div>
    <div class="lex-expandable-item"><strong>Verifique anexos:</strong> não envie arquivos muito grandes.</div>
    <div class="lex-expandable-item"><strong>Cuidado com phishing:</strong> desconfie de e-mails suspeitos.</div>
    <div class="lex-expandable-item"><strong>Responda prontamente:</strong> mantenha comunicação eficiente.</div>
    <div class="lex-expandable-item"><strong>Use formatação adequada:</strong> parágrafos curtos e claros.</div>
  </div>

  <div class="callout callout-gold">
    <span class="callout-icon">💡</span>
    <strong>Bizu:</strong> SMTP = envia &nbsp;|&nbsp; POP3 = recebe e apaga &nbsp;|&nbsp; IMAP = recebe e mantém &nbsp;|&nbsp; Cc = todos veem &nbsp;|&nbsp; Bcc = ninguém vê
  </div>
...
<div class="lex-block">
  ...
  <div class="lex-expandable-item">
    <strong>Definição:</strong> Malware disfarçado de programa legítimo (o famoso "presente grego"). Apresenta-se como um software útil para convencer o usuário a executá-lo.
  </div>

  <div class="lex-expandable-item">
    <strong>Engenharia Social:</strong> Seu sucesso depende da falha humana. O usuário o instala voluntariamente, sendo enganado pelo disfarce de algo benéfico.
  </div>

  <div class="lex-expandable-item">
    <strong>NÃO se replica:</strong> Diferente de vírus e worms, o Trojan <strong>não cria cópias de si mesmo</strong> e não se dissemina automaticamente pela rede.
  </div>

  <div class="lex-expandable-item">
    <strong>Backdoors:</strong> Sua principal função é abrir "portas dos fundos", permitindo que outros malwares entrem ou que invasores tomem o controle remoto do sistema.
  </div>

    <div class="lex-section-title">Palavras-Chave para Identificação (Trojan)</div>
    <div class="lex-cols">
       <div class="lex-expandable-item"><strong>Aparentemente Seguro:</strong> O software parece inofensivo e útil.</div>
       <div class="lex-expandable-item"><strong>Disfarce:</strong> Esconde sua real intenção maliciosa sob fachada legítima.</div>
       <div class="lex-expandable-item"><strong>Controle Remoto:</strong> Uma vez instalado, permite acesso total ao sistema.</div>
       <div class="lex-expandable-item"><strong>Instalação Voluntária:</strong> O usuário é quem executa o arquivo enganado.</div>
       <div class="lex-expandable-item"><strong>Presente Grego:</strong> Referência clássica em provas - algo bom que esconde mal.</div>
       <div class="lex-expandable-item"><strong>Backdoor:</strong> Abre porta de acesso para futuras invasões.</div>
    </div>
</div>
    <div class="lex-section-container">
    ...
    <div class="lex-section-container">
      ...
      <div class="lex-expandable-item"><strong>Rootkit:</strong> Conjunto de ferramentas que <strong>esconde a invasão</strong> em níveis profundos do sistema (Kernel).</div>
        ...
        <div class="lex-section-container">
        <div class="lex-section-title">Bot</div>
         <div class="lex-expandable-item"><strong>Propagação:</strong> Capaz de se propagar automaticamente, explorando vulnerabilidades.</div>
      <div class="lex-expandable-item"><strong>Controle:</strong> Permite o <strong>acesso remoto</strong> do invasor ao equipamento infectado.</div>
      <div class="lex-expandable-item"><strong>Ação:</strong> Transforma o computador em um "zumbi" para realizar ataques coordenados.</div>
...
<div class="lex-section-container">
  ...
  <div class="lex-expandable-item">
    <strong>Conceito:</strong> Técnica de fraude que utiliza engenharia social para enganar usuários e obter dados confidenciais (senhas, cartões, CPF).
  </div>

  <div class="lex-expandable-item">
    <strong>Variações Importantes:</strong>
    <ul>
      <li><strong>Spear Phishing:</strong> Ataque <strong>direcionado</strong> e personalizado a uma pessoa ou empresa específica.</li>
      <li><strong>Whaling:</strong> Phishing focado em "peixes grandes" (CEOs, executivos ou autoridades).</li>
      <li><strong>Vishing:</strong> Phishing realizado via <strong>voz</strong> (chamadas telefônicas fraudulentas).</li>
      <li><strong>Smishing:</strong> Phishing via <strong>SMS</strong> ou mensagens de texto instantâneas.</li>
      <li><strong>Pharming:</strong> Envenenamento de DNS. O usuário digita a URL correta, mas o tráfego é redirecionado para um site falso.</li>
    </ul>
  </div>

  <div class="lex-section-title">Termos e Gatilhos Mentais</div>
  
  <div class="lex-cols">
    <div class="lex-expandable-item">
      <strong>Engenharia Social:</strong> Manipulação psicológica da vítima para que ela execute ações ou forneça dados.
    </div>
    <div class="lex-expandable-item">
      <strong>Senso de Urgência:</strong> Uso de ameaças como "Sua conta será bloqueada" para forçar uma ação rápida e impensada.
    </div>
    <div class="lex-expandable-item">
      <strong>Spoofing:</strong> Técnica de <strong>falsificar a origem</strong> (e-mail, IP ou telefone) para parecer uma fonte confiável.
    </div>
    <div class="lex-expandable-item">
      <strong>Look-alike Domain:</strong> Uso de domínios visualmente similares aos originais para enganar a percepção (ex: <i>rnicrosoft.com</i>).
    </div>
</div>
  ...
  <div class="callout callout-gold">
   ...
   <div class="lex-section-container">
      <div class="lex-section-title">Outros Ataques Comuns</div>
      <div class="lex-expandable-item"><strong>Defacement:</strong> Pichação ou deformação de sites; usado para mentir ou passar mensagens políticas.</div>
      <div class="lex-expandable-item"><strong>Phishing:</strong> O famoso <strong>golpe</strong> para pescar dados através de fraude.</div>
      <div class="lex-expandable-item"><strong>Hijacker:</strong> Malware focado em <strong>infectar o browser</strong> (sequestro do navegador), alterando página inicial e buscas.</div>
    </div>
  </div>

  <div class="callout callout-orange">
    <div class="callout callout-orange">Resumo Comparativo para Revisão</div>
    <div>🔴 <strong>VÍRUS:</strong> Precisa de HOSPEDEIRO + EXECUÇÃO HUMANA.</div>
    <div>🔵 <strong>WORM:</strong> Independente + REPLICAÇÃO AUTOMÁTICA via rede.</div>
    <div>🟢 <strong>TROJAN:</strong> Disfarce + NÃO SE REPLICA.</div>
    <div>🟡 <strong>RANSOMWARE:</strong> Sequestro + CRIPTOGRAFIA.</div>
  </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Scan & Brute Force</div>
    <div class="lex-expandable-item"><strong>Scan (Varredura):</strong> Técnica para <strong>mapear redes</strong> e identificar portas abertas, serviços ativos e vulnerabilidades.</div>
    <div class="lex-expandable-item"><strong>Tipos de Scan:</strong> Port Scan (varredura de portas), Network Scan (mapeamento de rede), Vulnerability Scan (identificação de falhas).</div>
    <div class="lex-expandable-item"><strong>Brute Force (Força Bruta):</strong> Ataque que testa <strong>systematicamente</strong> todas as combinações possíveis de senhas.</div>
    <div class="lex-expandable-item"><strong>Mecanismos:</strong> Dictionary Attack (usando lista de palavras), Hybrid Attack (combina dicionário com variações), Rainbow Tables.</div>
    <div class="lex-expandable-item"><strong>Ferramentas Comuns:</strong> Nmap, Wireshark, John the Ripper, Hydra, Burp Suite.</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Outros Ataques e Técnicas</div>
    <div class="lex-expandable-item"><strong>DoS/DDoS:</strong> Negação de serviço distribuído - sobrecarga de requisições para derrubar servidores.</div>
    <div class="lex-expandable-item"><strong>Man-in-the-Middle (MITM):</strong> Intercepta comunicação entre duas partes sem que elas percebam.</div>
    <div class="lex-expandable-item"><strong>SQL Injection:</strong> Injeção de código SQL malicioso para manipular bancos de dados.</div>
    <div class="lex-expandable-item"><strong>Cross-Site Scripting (XSS):</strong> Injeção de scripts em páginas web para roubar dados de usuários.</div>
    <div class="lex-expandable-item"><strong>Zero-Day Exploit:</strong> Ataque que explora vulnerabilidade ainda não conhecida pelo fabricante.</div>
  </div>
  </div>
  ...
  <div class="callout callout-rose">
    <span class="callout-icon">⚠️</span>
    <strong>Atenção:</strong> O <b>Trojan</b> sempre virá em provas associado à ideia de "Presente Grego" — algo que parece bom, mas carrega uma ameaça interna que não se espalha sozinho (precisa de você para abrir a porta). Diferente de vírus e worms, <strong>não se replica</strong> automaticamente.
  </div>

  <div class="callout callout-gold">
    <span class="callout-icon">🎯</span>
    <strong>Dica de Prova:</strong> Em questões sobre <strong>Scan</strong>, procure por termos como "mapear rede", "identificar portas abertas", "varredura". Em <strong>Brute Force</strong>, o foco é "tentativa e erro", "combinações de senhas", "ataque sistemático".
  </div>

    <div class="callout callout-orange">
    <span class="callout-icon">💡</span>
    <strong>Resumo Rápido:</strong> 
    • <b>Bot:</b> Remoto e automático, forma botnets. 
    • <b>Brute Force:</b> Tentativa e erro de senhas sistemática. 
    • <b>Defacement:</b> Alterar a cara do site (pichação digital). 
    • <b>Hijacker:</b> Sequestro do navegador, redireciona buscas.
    • <b>Scan:</strong> Mapeamento de rede e identificação de vulnerabilidades.
    • <b>DDoS:</strong> Ataque coordenado para derrubar serviços.
  </div>
</div>
</div>`
  },
...
<div class="lex-block">
  <div class="notion-header">
    ...
    <div class="notion-meta">
      ...
      <span class="meta-tag tag-b">Essencial para Provas!</span>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">O que é o Firewall?</div>
    <div class="lex-expandable-item">É uma barreira de <strong>segurança lógica ou física</strong> que atua como a primeira linha de defesa.</div>
    <div class="lex-expandable-item">Monitora e controla o tráfego de <strong>entrada e saída</strong> com base em um conjunto de regras (ACLs).</div>
    <div class="lex-expandable-item">Decide se permite ou bloqueia o tráfego (Ex: <em>Allow</em> ou <em>Deny</em>).</div>
    <div class="lex-expandable-item">Pode ser implementado via <strong>Hardware</strong> (equipamento dedicado) ou <strong>Software</strong> (como o Firewall do Windows).</div>
  </div>

  <div class="lex-cols">
    <div class="lex-section-container">
      <div class="lex-section-title">O que o Firewall FAZ ✅</div>
      <div class="lex-expandable-item">✅ Filtra pacotes (IP, portas e protocolos)</div>
      <div class="lex-expandable-item">✅ Implementa políticas de segurança de rede</div>
      <div class="lex-expandable-item">✅ Isola a rede interna (confiável) da externa (não confiável)</div>
      <div class="lex-expandable-item">✅ Registra tentativas de acesso (Logs)</div>
      <div class="lex-expandable-item">✅ Oculta endereços da rede interna (NAT)</div>
    </div>
    <div class="lex-section-container">
      <div class="lex-section-title">O que o Firewall NÃO FAZ ❌</div>
      <div class="lex-expandable-item">❌ Não impede ataques que não passam por ele</div>
      <div class="lex-expandable-item">❌ Não remove vírus de arquivos infectados</div>
      <div class="lex-expandable-item">❌ Não substitui o backup</div>
      <div class="lex-expandable-item">❌ Não evita o uso indevido de senhas legítimas</div>
      <div class="lex-expandable-item">❌ Não protege contra engenharia social</div>
    </div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Tipos de Firewall</div>
    <div class="lex-expandable-item"><strong>Filtro de Pacotes (Stateless)</strong>: Analisa cabeçalhos isoladamente. Rápido, mas "esquece" o contexto da conexão.</div>
    <div class="lex-expandable-item"><strong>Stateful Inspection</strong>: Guarda o "estado" das conexões. Só permite a entrada de dados que foram solicitados internamente.</div>
    <div class="lex-expandable-item"><strong>Proxy de Aplicação</strong>: Age como intermediário completo. Analisa o conteúdo da camada de aplicação (HTTP, FTP).</div>
    <div class="lex-expandable-item"><strong>NGFW (Next Gen)</strong>: O mais moderno. Possui inspeção profunda (DPI) e reconhece quais aplicativos estão rodando.</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">Conceitos Relacionados</div>
    <div class="lex-expandable-item"><strong>UTM (Unified Threat Management)</strong>: Dispositivo "tudo em um" que inclui firewall, antivírus de rede e VPN.</div>
    <div class="lex-expandable-item"><strong>IDS (Detecção)</strong>: O "vigia" que apenas avisa sobre invasões (passivo).</div>
    <div class="lex-expandable-item"><strong>IPS (Prevenção)</strong>: O "segurança" que avisa e bloqueia o ataque em tempo real (ativo).</div>
  </div>

  <div class="callout callout-rose">
    <span class="callout-icon">⚠️</span>
    <strong>Cuidado com a Generalização:</strong> Dizer que o firewall "não protege contra ataques internos" é comum em provas, mas tecnicamente ele protege <strong>segmentos</strong> da rede. No entanto, para provas de nível básico, foque que ele foca no perímetro (fronteira).
  </div>
</div>
...
<div class="lex-block">
  ...
  <div class="lex-section-container">
    <div class="lex-section-title">🔒 Conceitos Fundamentais de Segurança</div>
    <div class="lex-expandable-item"><strong>Autenticação:</strong> verificar identidade do usuário (senha, biometria, 2FA)</div>
    <div class="lex-expandable-item"><strong>Autorização:</strong> definir o que usuário autenticado pode fazer</div>
    <div class="lex-expandable-item"><strong>Confidencialidade:</strong> proteger informações contra acesso não autorizado</div>
    <div class="lex-expandable-item"><strong>Integridade:</strong> garantir que dados não foram alterados indevidamente</div>
    <div class="lex-expandable-item"><strong>Disponibilidade:</strong> garantir que sistemas estejam acessíveis quando necessário</div>
    <div class="lex-expandable-item"><strong>Não repúdio:</strong> garantir que ações possam ser rastreadas ao autor</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">🛡️ Políticas de Segurança</div>
    <div class="lex-expandable-item"><strong>Política de Senhas:</strong> requisitos de complexidade, troca periódica</div>
    <div class="lex-expandable-item"><strong>Política de Acesso:</strong> princípio do menor privilégio</div>
    <div class="lex-expandable-item"><strong>Política de Uso Aceitável:</strong> regras para uso dos recursos da organização</div>
    <div class="lex-expandable-item"><strong>Plano de Resposta a Incidentes:</strong> procedimentos para lidar com ataques</div>
    <div class="lex-expandable-item"><strong>Classificação de Informações:</strong> público, interno, confidencial, secreto</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">🔐 Controles de Acesso</div>
    <div class="lex-expandable-item"><strong>Autenticação de Fator Único:</strong> apenas senha</div>
    <div class="lex-expandable-item"><strong>Autenticação de Dois Fatores (2FA):</strong> senha + outro fator</div>
    <div class="lex-expandable-item"><strong>Autenticação Multifator (MFA):</strong> múltiplos fatores de verificação</div>
    <div class="lex-expandable-item"><strong>Biometria:</strong> impressão digital, facial, íris, voz</div>
    <div class="lex-expandable-item"><strong>Tokens:</strong> dispositivos físicos ou aplicativos</div>
    <div class="lex-expandable-item"><strong>Smart Cards:</strong> cartões com chip para autenticação</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">📊 Auditoria e Monitoramento</div>
    <div class="lex-expandable-item"><strong>Logs de Sistema:</strong> registro de eventos e atividades</div>
    <div class="lex-expandable-item"><strong>Auditoria de Acesso:</strong> quem acessou o quê e quando</div>
    <div class="lex-expandable-item"><strong>Monitoramento em Tempo Real:</strong> detecção imediata de anomalias</div>
    <div class="lex-expandable-item"><strong>Análise Forense:</strong> investigação de incidentes de segurança</div>
    <div class="lex-expandable-item"><strong>SIEM:</strong> gerenciamento de eventos e informações de segurança</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">🏢 Segurança Física</div>
    <div class="lex-expandable-item"><strong>Controle de Acesso Físico:</strong> crachás, biometria, guardas</div>
    <div class="lex-expandable-item"><strong>Câmeras de Segurança:</strong> monitoramento de áreas críticas</div>
    <div class="lex-expandable-item"><strong>Sala de Servidores:</strong> ambiente controlado, acesso restrito</div>
    <div class="lex-expandable-item"><strong>Destruição de Mídia:</strong> descarte seguro de dados</div>
    <div class="lex-expandable-item"><strong>Plano de Desastre:</strong> recuperação de sistemas e dados</div>
  </div>

  <div class="lex-section-container">
    <div class="lex-section-title">📋 Conformidade e Regulamentações</div>
    <div class="lex-expandable-item"><strong>LGPD:</strong> Lei Geral de Proteção de Dados (Brasil)</div>
    <div class="lex-expandable-item"><strong>GDPR:</strong> General Data Protection Regulation (Europa)</div>
    <div class="lex-expandable-item"><strong>PCI DSS:</strong> padrão para dados de cartão de crédito</div>
    <div class="lex-expandable-item"><strong>ISO 27001:</strong> padrão internacional de gestão de segurança</div>
    <div class="lex-expandable-item"><strong>Sarbanes-Oxley:</strong> governança corporativa (EUA)</div>
  </div>

  <div class="callout callout-gold">
    <span class="callout-icon">💡</span>
    <strong>Bizu:</strong> CIA = Confidencialidade, Integridade, Disponibilidade &nbsp;|&nbsp; 2FA = senha + outro fator &nbsp;|&nbsp; LGPD = proteção de dados pessoais
  </div>
</div>`
  }, 
